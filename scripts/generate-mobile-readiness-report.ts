...
async function main() {
  ...
  const report = [
    ...
    '## Source Checklist',
    '',
    'Use `docs/mobile-launch-checklist.md` as the authoritative checklist, `npm run mobile:evidence:init` to start final installed-build signoff, and `npm run mobile:evidence:check` before final store review submission.',
