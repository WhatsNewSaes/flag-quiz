...
Package the current store assets and launch docs for handoff with `npm run package:store-submission`. The generated package is written to `dist/mobile-store-submission/` and is intentionally not committed.
